<template>
  <div style="position:relative;">
    ...
    <v-container id="dashboardThirdSection" tag="section">
      <v-row align="center" no-gutters style="font-size:21px;">
        <v-col cols="12" md="4" class="d-flex justify-center">
          <div class="tInfoDiv" @click="skemaClicked(1)">
            <div
              style="background:transparent; width:100%; height:100%; position:absolute; top:0; left:0;z-index:1;"
            ></div>
            <v-icon class="tInfoIcon" x-large style="padding:0 5px;"
              >mdi-book-open-page-variant</v-icon
            >
            <h1 style="font-size:44px">{{ totalSkema }}</h1>
            <p>Skema Sertifikasi</p>
          </div>
        </v-col>
        <v-col cols="12" md="4" class="d-flex justify-center">
          <div class="tInfoDiv" @click="skemaClicked(2)">
            <div
              style="background:transparent; width:100%; height:100%; position:absolute; top:0; left:0;z-index:1;"
            ></div>
            <v-icon class="tInfoIcon" x-large style="padding:0 5px;"
            ...
            >
            <h1 style="font-size:44px">{{ totalAsesor }}</h1>
            <p>Asesor Kompetensi</p>
          </div>
        </v-col>
        <v-col cols="12" md="4" class="d-flex justify-center">
          <div class="tInfoDiv" @click="skemaClicked(3)">
            <div
              style="background:transparent; width:100%; height:100%; position:absolute; top:0; left:0;z-index:1;"
            ></div>
            <v-icon class="tInfoIcon" x-large style="padding:0 5px;"
              >mdi-medal</v-icon
            >
            <h1 style="font-size:44px">{{ totalAsesi }}</h1>
            <p>Pemegang Sertifikat</p>
          </div>
        </v-col>
        <!-- <v-col cols="12" md="3" class="d-flex justify-center">
          <div class="tInfoDiv" @click="skemaClicked(4)">
            <div
              style="background:transparent; width:100%; height:100%; position:absolute; top:0; left:0;z-index:1;"
            ></div>
            <v-icon class="tInfoIcon" x-large style="padding:0 5px;"
            ...
            >
            <h1 style="font-size:44px">{{ totalTuk }}</h1>
