<template>
  <div style="padding:0;overflow:hidden;" class="top">
    ...
    <!-- <a
      id="ScrollTop"
      href="#top"
      style="font-size:0;height:0; width:0;padding:0;margin:0;"
      >click</a
    > -->
  </div>
</template>
...
export default {
  ...
  components: {
    DashboardFirstSection: () => import('./section/First'),
    // DashboardSecondSection: () => import('./section/Second'),
