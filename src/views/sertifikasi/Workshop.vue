            ...
            <v-card tile elevation="1" text class="skemaTableDiv">
              ...
              >
                <v-toolbar-title
                  ...
                  "
                >
                  Daftar Workshop / Training LPK KPMI
                </v-toolbar-title>
                <v-btn
...
export default {
  ...
  components: {
    formEdit: () => import('./form/Workshop'),
    formAdd: () => import('./form/Workshop')
  },
  ...
  methods: {
    ...
    loadTable() {
      axios
        .get(`http://localhost:3001/workshop?page=${this.page}&limit=${this.limit}`)
        .then(res => {
    ...
    deleteItem(id) {
      this.showMsgDialog(
        ...
        if (res.value) {
          axios
            .delete(`http://localhost:3001/workshop/${id}`)
