            ...
            <v-card tile elevation="1" text class="skemaTableDiv">
              ...
              >
                <v-toolbar-title
                  ...
                  "
                >
                  Daftar Asesor Kompetensi LSP Promigas Indonesia
                </v-toolbar-title>
                <v-btn
              ...
              >
                ...
                <template v-slot:[`header.nama_asesor`]="{ header }">
                  <div style="font-weight:bold; padding:0;font-size:14px">
                    {{ header.text }}
                  </div>
                </template>
                <template v-slot:[`header.nomor_registrasi`]="{ header }">
                  <div style="font-weight:bold; padding:0;font-size:14px">
                    {{ header.text }}
                  </div>
                </template>
                <template v-slot:[`header.kompetensi_teknis`]="{ header }">
                  <div style="font-weight:bold; padding:0;font-size:14px">
                    {{ header.text }}
                  </div>
                </template>
                ...
                <template v-slot:[`item.nama_asesor`]="{ item }">
                  <div v-html="item.nama_asesor"></div>
                </template>
